import { CloudArrowUpIcon, BriefcaseIcon, LanguageIcon, WrenchIcon, PuzzlePieceIcon, CommandLineIcon } from '@heroicons/react/20/solid'
            ...
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className="flex flex-col">
                    <div className="relative sm:block lg:inline-flex gap-x-10 my-5 -ml-10 p-10">
                        <div style={{backgroundImage: `url(${sphImage})`}} className="shadow-xl sm:relative lg:sticky mt-5 mb-2 h-min lg:top-40 w-full bg-center bg-cover aspect-16/9 rounded-xl "></div>
                    ...
                    <div className="relative sm:block lg:inline-flex gap-x-10 my-5 -ml-10 p-10">
                        <div className="lg:w-full pt-10lg:pt-0">
                            <div style={{backgroundImage: `url(${blogImage})`}} className="lg:hidden sm:relative lg:sticky mt-5 mb-2 h-min lg:top-40 w-full bg-center bg-cover aspect-16/9 rounded-xl "></div>
                            <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-100 sm:text-5xl">
                                Blog
                            </h1>
                            <p className="mt-6 text-xl/8 text-gray-400">
                        ...
                        <div style={{backgroundImage: `url(${blogImage})`}} className="shadow-xl hidden sm:hidden lg:block sm:relative lg:sticky mt-5 mb-2 h-min lg:top-40 w-full bg-center bg-cover aspect-16/9 rounded-xl "></div>
                    </div>
                </div>
            </div>
        </div>
