    ...
    return (
        <div id='projects' className="bg-slate-900 py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                <h2 className="text-center text-base/7 font-semibold text-purple-400">Проекты</h2>
                ...
                <div className="relative lg:row-span-2">
                    <div className="absolute inset-px rounded-lg bg-slate-950 lg:rounded-l-[2rem]"></div>
                ...
                <div className="relative max-lg:row-start-1 ">
                    <div className="absolute inset-px rounded-lg bg-slate-950 max-lg:rounded-t-[2rem]"></div>
                ...
                <div className="relative lg:row-span-2">
                    <div className="absolute inset-px rounded-lg bg-slate-950 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
